...
class TimeWeightingDetector:
    def __init__(self, fs: float, mode: str = 'Fast', ref_pressure: float = 20e-6):
        self.fs = fs
        self.mode = mode
...
class StreamProcessor:
    ...
    def run_analysis(self, 
                     ...
                     band_order: int = 24,           # Configurable
                     time_weighting: str = 'Fast',
                     ref_pressure: float = 20e-6     # Configurable
